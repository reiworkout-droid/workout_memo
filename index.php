...
document.addEventListener('input', function (event) {
  ...
  // 各input取得
  const weightInput = textArea.querySelector('input[name="weight"]');
  const repsInput   = textArea.querySelector('input[name="reps"]');
  const rmHidden    = textArea.querySelector('input[name="max"]');
  const rmDisplay   = textArea.querySelector('.rmDisplay');
